...
//                System.out.printf("%s %s %s", person.getName(), (person.getSex() == Sex.MALE ? "м" : "ж"), simpleDateFormat.format(person.getBirthDay()));
...
//                System.out.printf("%s %s %s", person1.getName(), (person1.getSex() == Sex.MALE ? "м" : "ж"), simpleDateFormat.format(person1.getBirthDay()));
                break;
            }
            case "-d": {
                Person person = allPeople.get(Integer.parseInt(args[1]));
...
//                name sex (м/ж) bd (формат 15-Apr-1990)
                ...
                System.out.printf("%s %s %s", person.getName(), (person.getSex() == Sex.MALE ? "м" : "ж"), simpleDateFormat1.format(person.getBirthDay()));
                break;
            }
        }
    }
